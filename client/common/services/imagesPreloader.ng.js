...
.factory("imagesPreloader",
  function( $q, $rootScope ) {
    // Manage the preloading of image objects. Accepts an array of image URLs.
    function Preloader( imageLocations ) {
        // The image SRC values to preload.
        this.imageLocations = imageLocations;
        // As the images load, keep track of the load/error
        // counts when announing the progress on the loading.
        this.imageCount = this.imageLocations.length;
        this.loadCount = 0;
        this.errorCount = 0;
        // The possible states that the preloader can be in.
        this.states = { PENDING: 1, LOADING: 2, RESOLVED: 3, REJECTED: 4 };
        // Keep track of the current state of the preloader.
    ...
    Preloader.prototype = {
        ...
        // Load the given image location and then wire the load / error
